...
import org.example.ecommerce.security.jwt.*;
import org.example.ecommerce.security.service.UserDetailsImpl;
...
public class AuthController {
    ...
    public ResponseEntity<?> authenticateUser(@RequestBody LoginRequest loginRequest) {
        ...
        LoginResponse response = new LoginResponse(userDetails.getId(),userDetails.getUsername(), roles, jwtCookie.getValue());
